document.addEventListener("DOMContentLoaded", () => {
  ...
  // so the div in our grid being 2
  // (or the Head), and 0 being the end (TAIL, with all 1's)
  // being the body from now on.
  let direction = 1;
  let score = 0;
  let speed = 0.9;
  let intervalTime = 0;
  ...
  // deals with snake hiting border and hitting self
